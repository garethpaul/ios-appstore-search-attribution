...
available, the baseline also runs `xcodebuild -list` against the sample project
to verify project-file integrity. It does not call ADClient, inspect attribution
